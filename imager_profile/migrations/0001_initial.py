    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photographer', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='imager_profile.Photographer')),
            ],
        ),
        migrations.AddField(
            model_name='equipment',
            name='photographer',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='imager_profile.Photographer'),
        ),
        migrations.AddField(
            model_name='address',
            name='photographer',
