# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-09-25 05:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photographer_profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='SocialMedia', to='imager_profile.Photographer')),
            ],
        ),
        migrations.AddField(
            model_name='equipment',
            name='photographer_profile',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='imager_profile.Photographer'),
        ),
        migrations.AddField(
            model_name='address',
            name='photographer_profile',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='imager_profile.Photographer'),
        ),
    ]
